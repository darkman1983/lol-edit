...
class ModelViewer
{
  ...
  */
   ...
   * Method: SetModel()
  *
  * Sets the Model of the Creature model to the specified ID.
  *
  * ---
  *
  * Param: ModelId (string) - Model identifier in string format.
  *
  * Return: (none)
  */
  ...
  {
    if( !$ModelId )
      trigger_error( "'$ModelId' is not recognized as a valid Model.", E_USER_WARNING );
...
HTML;
  ...
  /*
   * Mthod: GetCreatureHtml()
  *
  * Returns the HTML <object> tag for the Creature model viewer with all relevant data.
  *
  * ---
  *
  * Return: (string) - The HTML code for the Creature model viewer.
  */
  public function GetCreatureHtml()
  {
    $HtmlFormat = <<<HTML
<object type="application/x-shockwave-flash" data="http://wow.zamimg.com/modelviewer/ZAMviewerfp11.swf" width="%u" height="%u" id="dsjkgbdsg2346" style="visibility: visible;">
    <param name="quality" value="high">
    ...
    <param name="bgcolor" value="#181818">
    <param name="wmode" value="direct">
    <param name="flashvars" value="model=%s&amp;modelType=8&amp;contentPath=http://wow.zamimg.com/modelviewer/&amp;%s">
</object>
HTML;
    ...
    return sprintf( $HtmlFormat, $this->ObjectWidth, $this->ObjectHeight, $this->Model, $EquipList );
  }
