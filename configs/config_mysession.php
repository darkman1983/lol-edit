<?PHP
#Section 1: Table and columns name
...
$_MYSESSION_CONF['CRIPT_KEY']       =   "godthatlolisthebestYAY!"; //Encrypt Key: The strongest key that your mind can think. You do not need to remember it!!!

#Section 2.4: Hijacking Prevention
$_MYSESSION_CONF['ENABLE_ANTI_HIJACKING'] = 1;                     //Use UserAgent check to prevent Hijacking
$_MYSESSION_CONF['ANTI_HIJACKING_SALT']   = "antiHijackLoLWoW";    //The salt used to adding more security to the UserAgent check
?>
